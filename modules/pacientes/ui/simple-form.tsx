...
/** Minimal Server Action form wrapper for `/catalogos/pacientes` -- see modules/proveedores/ui/simple-form.tsx for the shared shape. */
...
export interface SimpleFormProps {
  action: (prevState: PacienteActionState, formData: FormData) => Promise<PacienteActionState>;
  children: ReactNode;
  submitLabel: string;
  pendingLabel?: string;
