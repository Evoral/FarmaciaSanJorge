...
/** Minimal Server Action form wrapper for `/recetas` -- see modules/pacientes/ui/simple-form.tsx for the shared shape (own copy per module). */
...
export interface SimpleFormProps {
  ...
  onSuccess?: (state: Extract<RecetaActionState, { status: "success" }>) => void;
  className?: string;
}
