...
function PasswordField() {
  return (
    <div className="flex flex-col gap-1">
      ...
      <input id="password" name="password" type="password" autoComplete="off" required className="rounded border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
    ...
    <div className="rounded border border-zinc-300 p-4 dark:border-zinc-700">
      ...
      <SimpleForm action={autorizarDestruccionAction} submitLabel="Autorizar destrucción" pendingLabel="Autorizando…" className="flex max-w-lg flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input id="expedienteAutorizacion" name="expedienteAutorizacion" type="text" required className="rounded border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
        </div>
        <div className="flex flex-col gap-1">
          <label htmlFor="fechaAutorizacion" className="text-sm font-medium">
            Fecha de autorización
          </label>
          <input id="fechaAutorizacion" name="fechaAutorizacion" type="date" required className="rounded border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
        </div>
        <PasswordField />
      </SimpleForm>
    </div>
    ...
    <div className="rounded border border-zinc-300 p-4 dark:border-zinc-700">
      ...
      <SimpleForm action={registrarDestruccionAction} submitLabel="Registrar destrucción" pendingLabel="Registrando…" submitDisabled={!confirma} className="flex max-w-lg flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input id="fechaDestruccion" name="fechaDestruccion" type="date" required className="rounded border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
        </div>
        <PasswordField />
      </SimpleForm>
    </div>
