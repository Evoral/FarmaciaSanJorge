...
/**
 * Minimal Server Action form wrapper for `/admin/unidades` (FASE 4 point
 * 4.1) -- same role as modules/usuarios/ui/reauth-aware-form.tsx, WITHOUT
 * the re-authentication branch (this module's commands never declare
 * `requireRecentReauth`, see ./action-state.ts).
 */
