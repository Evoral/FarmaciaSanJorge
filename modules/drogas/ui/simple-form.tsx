...
/** Minimal Server Action form wrapper for `/catalogos/drogas` -- see modules/unidades/ui/simple-form.tsx for the shared shape (none of this module's commands declare `requireRecentReauth` either). */
...
export interface SimpleFormProps {
  action: (prevState: DrogaActionState, formData: FormData) => Promise<DrogaActionState>;
  children: ReactNode;
  submitLabel: string;
  pendingLabel?: string;
