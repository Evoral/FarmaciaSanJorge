...
/**
 * Generic wrapper for `/admin/parametros`'s sensitive edit action (FASE 3
 * point 3.10b -- editing a weighing parameter requires recent
 ...
 * same `modules/auth/ui/reauth-prompt.tsx` reuse.
 */
...
export interface ReauthAwareFormProps {
  action: (prevState: ParametrosActionState, formData: FormData) => Promise<ParametrosActionState>;
  children: ReactNode;
  submitLabel: string;
  pendingLabel?: string;
