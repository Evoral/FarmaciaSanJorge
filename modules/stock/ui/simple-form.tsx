...
/** Minimal Server Action form wrapper for `/stock/**` -- own copy, see modules/proveedores/ui/simple-form.tsx for the shared shape. */
...
export interface SimpleFormProps {
  action: (prevState: StockActionState, formData: FormData) => Promise<StockActionState>;
  children: ReactNode;
  submitLabel: string;
  pendingLabel?: string;
