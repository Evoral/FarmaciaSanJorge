...
async function main(): Promise<void> {
  ...
  try {
    ...
    // and migration 0038 (plazo_firma_dias), migration 0040
    // (plazo_regularizacion_dias) and migration 0042 (plazo_archivo_comun_anios /
    // plazo_archivo_controladas_anios) -- kept here so every path (a
